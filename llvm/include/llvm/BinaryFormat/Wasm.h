...
enum : unsigned {
  ...
  WASM_TYPE_STRINGREF = 0x64,
  WASM_TYPE_STRINGVIEW_WTF8 = 0x63,
  WASM_TYPE_STRINGVIEW_WTF16 = 0x62,
  WASM_TYPE_STRINGVIEW_ITER = 0x61,
  WASM_TYPE_FUNC = 0x60,
...
struct ValType {
  enum TypeKind : uint32_t {
    ...
    STRINGREF = WASM_TYPE_STRINGREF,
    STRINGVIEW_WTF8 = WASM_TYPE_STRINGVIEW_WTF8,
    STRINGVIEW_WTF16 = WASM_TYPE_STRINGVIEW_WTF16,
    STRINGVIEW_ITER = WASM_TYPE_STRINGVIEW_ITER,
    IDX = 0
  };
  TypeKind Kind;
  uint32_t TypeIdx;
