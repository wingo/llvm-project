...
/// Need to override this as some load/store optimizations crash when
/// we don't return a proper value for opaque types.
Align WebAssemblyTargetLowering::getABIAlignmentForCallingConv(
    Type *ArgTy, DataLayout DL) const {
