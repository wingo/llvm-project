...
; CHECK-NEXT:    # fallthrough-return
 ...
 store %externref %arg, %alloca_cell %retval
 call void @inhibit_store_to_load_forwarding()
 %reloaded = load %externref, %alloca_cell %retval
...
; CHECK-NEXT:    # fallthrough-return
 ...
 store %funcref %arg, %alloca_cell %retval
 call void @inhibit_store_to_load_forwarding()
 %reloaded = load %funcref, %alloca_cell %retval
